...
public class NodesAtKdistanceFromLeaf {
	...
	public void printPaths(Node root, int[] path, int pathLen,
		...
		// The key is that if another leaf shares a same common subpath, we dont want to print the node at that distance.
		// Once we switch to a different subpath to a leaf, we will print...this is all taken care by recursion.
